...
(function ($) {
    ...
    $.fn.fileinputLocales['hu'] = {
        ...
        msgPlaceholder: 'Válasszon {files}okat...',
        ...
        msgFilesTooLess: 'Legalább <b>{n}</b> {file}t ki kell választania a feltöltéshez.',
        ...
        msgLoading: '{index}. {file} töltése&hellip;',
        msgProgress: '{index}. {file} töltése&hellip; - {name} - {percent}% kész.',
        msgSelected: '{n} {file} kiválasztva.',
        ...
        msgResumableUploadRetriesExceeded: '<b>{fájl}</b> fájl feltöltés megszakítva <b>{max}</b> próbálkozás után! Hiba részletei: <pre>{error}</pre>',
